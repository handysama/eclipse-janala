...
public class LaunchResources {
  ...
  private static final IPath LAUNCH_PATH = Activator.getDefault().getStateLocation().append(LAUNCH_SEGMENT);
  ...
  private ArgumentCollector fArguments;
   ...
   */
  public LaunchResources(ArgumentCollector args, IProgressMonitor monitor) throws CoreException {
   ...
   */
  public ArgumentCollector getArguments() {
    return fArguments;
  }
